...
- **THEN** 生成 `prototype/data/map01.json`：cell_w=64、cell_h=96、px 2048×1536、page 8×6；三层各 6,144 项；层值分布与 formats.md §5 一致（terrain 全格有值 {1..5,9..13,17}、variant≈35 格非零、object 全 0）
...
- **THEN** 两值均为 JSON layers.terrain 中的合法值（1..17 域，全格非零）
