...
void blit_0x424140(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (param_1 != 0) {
    ...
    if (iStack_24 != 0) {
      uStack_2c = func_0x00424510(uStack_28,uStack_1c,uStack_18,param_4);
      (*API_GDI32_DLL_DeleteObject)(iStack_24);
      __chkesp();
    }
  }
  puStack_8 = &UNK_00424310;
  __chkesp();
  return;
}
