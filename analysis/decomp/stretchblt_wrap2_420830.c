...
void __thiscall
stretchblt_wrap2(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if ((*param_1 != 0) && (param_1[5] != 0)) {
    ...
    (*API_GDI32_DLL_StretchBlt)
              (param_2,param_3,param_4,param_5,param_6,piStack_8[4],0,0,
               *(undefined4 *)(*piStack_8 + 4),*(undefined4 *)(*piStack_8 + 8),&DAT_008800c6);
    __chkesp();
    ...
    (*API_GDI32_DLL_StretchBlt)
               ...
               *(undefined4 *)(*piStack_8 + 4),*(undefined4 *)(*piStack_8 + 8),0xee0086);
    __chkesp();
    (*API_GDI32_DLL_SelectObject)(piStack_8[2],uStack_c);
    __chkesp();
  }
  piStack_8 = (int *)&UNK_0042097f;
  __chkesp();
  return;
}
