...
int FUN__text1__0084dc84
              (LCID param_1,DWORD param_2,byte *param_3,int param_4,byte *param_5,int param_6,
              UINT param_7)

{
  ...
  if (0 < param_6) {
    param_6 = FUN__text1__0084d955(param_5,param_6);
  }
  if (DAT_008758d8 == 2) {
