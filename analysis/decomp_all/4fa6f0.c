...
void __fastcall FUN__text__004fa6f0(int param_1)

{
  ...
  if (*(char *)(param_1 + 0x142) == '\x01') {
    *(short *)(param_1 + 0x14c) =
         *(short *)(param_1 + 0x14c) + (short)(char)(&DAT_00755c34)[*(ushort *)(param_1 + 0x144)];
  ...
  if (*(char *)(param_1 + 0x142) == '\x02') {
    *(ushort *)(param_1 + 0x14c) =
         *(short *)(param_1 + 0x14c) - (ushort)(byte)(&DAT_00755c5c)[*(ushort *)(param_1 + 0x144)];
    *(short *)(param_1 + 0x144) = *(short *)(param_1 + 0x144) + 1;
  ...
  if (*(char *)(param_1 + 0x142) == '\x03') {
    *(short *)(param_1 + 0x14c) =
         *(short *)(param_1 + 0x14c) + (short)(char)(&DAT_00755cc4)[*(ushort *)(param_1 + 0x144)];
    *(short *)(param_1 + 0x144) = *(short *)(param_1 + 0x144) + 1;
  ...
  if (*(char *)(local_8 + 0x143) == '\x01') {
    *(ushort *)(local_8 + 0x14e) =
         *(short *)(local_8 + 0x14e) - (ushort)(byte)(&DAT_00755cdc)[*(ushort *)(local_8 + 0x146)];
