...
void FUN__text__005390c4(float *param_1,float *param_2,float *param_3,float *param_4)

{
  ...
  *param_1 = local_1c;
  param_1[0xc] = -(local_14 * param_2[2] + local_1c * *param_2 + local_18 * param_2[1]);
  param_1[1] = fVar4;
  param_1[5] = fVar6;
  param_1[9] = fVar5;
  fVar1 = param_2[1];
  ...
  param_1[6] = local_c;
  param_1[10] = local_8;
  param_1[0xd] = -(fVar5 * fVar3 + fVar4 * fVar2 + fVar6 * fVar1);
