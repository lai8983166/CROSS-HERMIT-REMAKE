...
void FUN__text__004c2500(int param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9254) = uVar1;
  uVar1 = FUN__text__004c2060(*(undefined4 *)(local_8 + 0x9250),*(undefined4 *)(local_8 + 0x9254),
                              *(undefined1 *)(local_c + 4));
  *(undefined4 *)(local_8 + 0x9258) = uVar1;
  if (*(int *)(local_8 + 0x9258) == 0) {
    *(undefined2 *)(local_8 + 0x24 + param_1 * 0x1c8) = 0;
    *(undefined4 *)(local_8 + 0x1c + param_1 * 0x1c8) = *(undefined4 *)(local_c + 0x10);
  }
  local_8 = 0x4c25ff;
  FUN__text__0056ce80();
  return;
