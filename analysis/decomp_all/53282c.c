...
void __thiscall FUN__text__0053282c(int param_1,uint param_2,uint param_3,int param_4)

{
  ...
  if (*(int *)(param_1 + 0x1058) != 0) {
    ...
    do {
      ...
      iVar3 = iVar6 + 8;
      iVar6 = iVar6 + 0x10;
      *puVar7 = (ushort)(((int)ROUND(*pfVar1 * _DAT_005d0e40 + fVar4) << 6 |
                         (int)ROUND(*(float *)(iVar2 + param_4) * _DAT_005d0e3c + fVar4)) << 5) |
