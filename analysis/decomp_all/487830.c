...
/* WARNING: Removing unreachable block (ram,0x004878fb) */

void __thiscall FUN__text__00487830(int param_1,int param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  if (local_9c == '\0') {
    *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
    ...
    if ((local_9c == '\x02') &&
       (iVar3 = FUN__text__00424f80(&DAT_0059e164,
                                    "E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f54 + 0x46,0), iVar3 != 0)) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    goto LAB__text__00487c97;
  }
  *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
  ...
  for (local_7c = 0; local_7c != *local_c; local_7c = local_7c + 1) {
    ...
    if ((*(short *)(param_2 + 2) != *(short *)(local_98 + 2)) &&
       (iVar3 = FUN__text__0048c950((int)*(short *)(param_4 + 1),param_2,local_98), iVar3 != 0)) {
      ...
      if (iVar3 != 0) {
        ...
        iVar3 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f54 + 0x3e);
        FUN__text__0046beb0(local_98,0xc19,iVar3 % 0x14 + -10,iVar4,uVar6,puVar7);
        local_80 = local_80 + 1;
      }
    }
  }
