...
void FUN__text__004dcde0(int param_1,void *param_2)

{
  ...
  *(undefined2 *)((int)param_2 + 0x12) = uVar1;
  local_1c = (int)*(short *)(local_8 + 0x20);
  local_20 = (uint)*(byte *)(param_1 + 0x34);
  local_24 = (int)*(short *)(local_8 + 0x22);
  local_c = __ftol();
  *(undefined2 *)((int)param_2 + 0x14) = 0x8300;
  local_8 = (undefined *)0x4dceb2;
  FUN__text__0056ce80();
  return;
}
