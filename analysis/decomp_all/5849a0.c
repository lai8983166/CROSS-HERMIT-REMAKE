...
uint FUN__text__005849a0(uint param_1)

{
  ...
  if (DAT_0080a62c == 0) {
    ...
    if ((int)param_1 < 0x100) {
      if (DAT_00764370 < 2) {
        local_14 = *(ushort *)(PTR_DAT_00764164 + param_1 * 2) & 1;
      }
      else {
        local_14 = FUN__text__0057bb50(param_1,1);
      }
      if (local_14 == 0) {
        return param_1;
      }
    ...
    iVar1 = FUN__text__005873f0(DAT_0080a62c,0x100,&local_c,local_8,&local_10,3,0,1);
    if (iVar1 != 0) {
      if (iVar1 == 1) {
