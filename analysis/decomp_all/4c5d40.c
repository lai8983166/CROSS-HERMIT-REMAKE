...
void FUN__text__004c5d40(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9258) = uVar1;
  uVar1 = FUN__text__004c1eb0(param_1,*(uint *)(local_c + 4) >> 0x1c,
                              *(uint *)(local_c + 4) & 0xfffffff);
  *(undefined4 *)(local_8 + 0x925c) = uVar1;
  FUN__text__004cc600(*(undefined4 *)(local_8 + 0x9250));
  FUN__text__004cc0f0(*(undefined4 *)(local_8 + 0x9250),*(undefined4 *)(local_8 + 0x9254),
                      *(undefined4 *)(local_8 + 0x9258));
  FUN__text__004cc8d0(*(undefined4 *)(local_8 + 0x925c));
  FUN__text__004cc500(*(undefined4 *)(local_8 + 0x925c));
  local_8 = 0x4c5e98;
  FUN__text__0056ce80();
  return;
}
