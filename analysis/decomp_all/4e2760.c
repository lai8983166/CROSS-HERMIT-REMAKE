...
void FUN__text__004e2760(undefined4 param_1,int param_2,uint param_3)

{
  ...
  if (((param_2 < 0) || (3 < param_2)) &&
     (iVar2 = FUN__text__00424f80("(0<=type)&&(type<=3)",
                                  "E:\\CrossHermit\\GAME\\SRC\\Common\\ComYken.cpp",DAT_00738cc4 + 3
                                  ,0), iVar2 != 0)) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  ...
  if (((param_2 < 0) || (400 < param_2)) &&
     (iVar2 = FUN__text__00424f80("(0<=type)&&(type<=400)",
                                  "E:\\CrossHermit\\GAME\\SRC\\Common\\ComYken.cpp",DAT_00738cc4 + 9
                                  ,0), iVar2 != 0)) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
