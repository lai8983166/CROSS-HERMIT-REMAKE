...
/* WARNING: Removing unreachable block (ram,0x0048388d) */

void __thiscall FUN__text__00483790(int param_1,int param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  if (local_a4 == '\0') {
    *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
    ...
    if ((local_a4 == '\x02') &&
       (iVar3 = FUN__text__00424f80(&DAT_0059da78,
                                    "E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f14 + 0x4e,0), iVar3 != 0)) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    goto LAB__text__00483bdb;
  }
  *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
  ...
  for (local_7c = 0; local_7c != *local_c; local_7c = local_7c + 1) {
    ...
    iVar3 = FUN__text__0048c950((int)*(short *)(param_4 + 1),param_2,local_a0);
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        if ((local_74 == 0) && (local_74 = 1, local_1c == 0)) {
          local_1c = 1;
        }
        _local_14 = CONCAT13(2,CONCAT12((undefined1)local_74,(short)param_4[1]));
        _local_10 = CONCAT22(-(short)local_1c,(short)param_4[2]);
        ...
        iVar3 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f14 + 0x46);
        FUN__text__0046beb0(local_a0,0xbbe,iVar3 % 0x14 + -10,iVar4,uVar6,puVar7);
        local_80 = local_80 + 1;
      }
    }
  }
