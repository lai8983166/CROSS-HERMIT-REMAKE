...
void __fastcall FUN__text__004187b0(int *param_1)

{
  ...
  if (*param_1 != 0) {
    ...
    FUN__text__00418b20();
    (**(code **)(*(int *)*local_8 + 0x34))(*local_8,local_58,0,FUN__text__00418c20,local_8 + 0x91,1)
    ;
    local_60 = FUN__text__0056ce80();
    local_5c = local_60;
    if ((local_60 != -0x7788fee8) && (local_60 != 0)) {
      FUN__text__0041b4a0(local_60);
    }
  }
  local_8 = (int *)0x41889e;
  FUN__text__0056ce80();
  return;
}
