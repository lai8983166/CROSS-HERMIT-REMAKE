...
void FUN__text__004c61c0(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x925c) = uVar1;
  ...
  FUN__text__004cc3e0(*(undefined4 *)(local_8 + 0x9250));
  FUN__text__004cc810(*(undefined4 *)(local_8 + 0x9250),*(undefined4 *)(local_8 + 0x925c));
  local_8 = 0x4c631c;
  FUN__text__0056ce80();
  return;
}
