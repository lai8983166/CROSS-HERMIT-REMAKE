...
void FUN__text__00469950(int param_1)

{
  ...
  if ((iVar2 == 0) &&
     (iVar2 = FUN__text__00424f80("IsUwUsed(wk)!=0",
                                  ...
                                  DAT_00618b94 + 2,0), iVar2 != 0)) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  }
  local_c = *(byte *)(*(int *)(param_1 + 600) + 0xa0);
  if ((local_c < 2) || (3 < local_c)) {
    local_10 = *(undefined1 *)(*(int *)(param_1 + 600) + 0x30);
  }
  local_8 = 0x469a1c;
  FUN__text__0056ce80();
  return;
