...
/* WARNING: Removing unreachable block (ram,0x004851e7) */

void __thiscall FUN__text__00485110(int param_1,int param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  if (local_40 == '\0') {
    ...
    *(undefined1 *)((int)param_4 + 9) = *(undefined1 *)(param_2 + 0x4f1);
    ...
    if ((local_40 == '\x02') &&
       (iVar3 = FUN__text__00424f80(&DAT_0059dcc4,
                                    "E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f2c + 0x41,0), iVar3 != 0)) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    goto LAB__text__004853d9;
  }
  *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
  ...
  for (local_20 = 0; local_20 != *local_c; local_20 = local_20 + 1) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        iVar3 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f2c + 0x39);
        FUN__text__0046beb0(local_3c,0xc17,iVar3 % 0x14 + -10,iVar4,uVar6,puVar7);
        local_24 = local_24 + 1;
      }
    }
  }
