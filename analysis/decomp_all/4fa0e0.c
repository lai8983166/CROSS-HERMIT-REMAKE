...
void __fastcall FUN__text__004fa0e0(int param_1)

{
  ...
  if (*(char *)(param_1 + 0x39) == '\x01') {
    *(undefined *)(param_1 + 0x69) = (&DAT_00755d00)[*(byte *)(param_1 + 0x51)];
  ...
  if (*(char *)(param_1 + 0x3a) == '\x01') {
    *(undefined *)(param_1 + 0x6a) = (&DAT_00755d44)[*(byte *)(param_1 + 0x52)];
  ...
  if (*(char *)(param_1 + 0x3b) == '\x01') {
    *(undefined *)(param_1 + 0x6b) = (&DAT_00755d70)[*(byte *)(param_1 + 0x53)];
