...
void FUN__text__0042f910(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9258) = uVar1;
  FUN__text__004e29e0(*(undefined4 *)(local_8 + 0x9254),1,*(undefined4 *)(local_8 + 0x9258),
                      *(undefined4 *)(local_8 + 0x9250));
  local_8 = 0x42f9f6;
  FUN__text__0056ce80();
  return;
}
