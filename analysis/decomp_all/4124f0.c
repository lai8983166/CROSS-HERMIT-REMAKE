...
void __thiscall FUN__text__004124f0(int param_1,int *param_2,uint param_3,uint param_4)

{
  ...
  if (*param_2 == 1) {
    if (param_2[4] <= *(int *)(param_1 + 0x9d4)) {
      ...
      if ((local_10 <= *local_c) && (local_14 <= local_c[1])) goto LAB__text__00412597;
    }
  }
  else {
LAB__text__00412597:
    if ((*(uint *)(local_8 + 0x8e4) & param_3) == 0) goto LAB__text__00412624;
    if (*param_2 == 0) {
      *param_2 = 1;
      param_2[4] = 0;
      ...
      goto LAB__text__00412624;
    }
    *(uint *)(local_8 + 0x8d8) = *(uint *)(local_8 + 0x8d8) | param_4;
    *(uint *)(local_8 + 0x8e0) = *(uint *)(local_8 + 0x8e0) | param_3;
  }
  *param_2 = 0;
LAB__text__00412624:
  local_8 = 0x41263b;
