...
void FUN__text__004c3400(undefined4 param_1,int param_2)

{
  ...
  *local_10 = 1;
  ...
  FUN__text__004cb8e0(*(undefined4 *)(local_8 + 0x9264));
  FUN__text__004cb890(*(undefined4 *)(local_8 + 0x9268),*(undefined4 *)(local_8 + 0x926c),
                      *(undefined4 *)(local_8 + 0x9270));
  local_8 = 0x4c3687;
  FUN__text__0056ce80();
  return;
}
