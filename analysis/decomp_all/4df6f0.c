...
void FUN__text__004df6f0(int param_1,int param_2,int param_3)

{
  ...
  if ((*(short *)(param_1 + 4) == 0x35) || (*(short *)(param_1 + 4) == 0x39)) {
  ...
  local_c = (uint)*(byte *)(param_3 + 9) + (int)*(short *)(&DAT_006c2de8 + iVar2) +
  ...
  *(undefined1 *)(param_3 + 9) = (undefined1)local_c;
  local_c = (uint)*(byte *)(param_3 + 0xc) + (int)*(short *)(&DAT_006c2dec + iVar2) +
            (int)((uint)*(byte *)(*(int *)(param_2 + 600) + 8) *
  ...
  *(undefined1 *)(param_3 + 0xc) = (undefined1)local_c;
  local_c = (uint)*(byte *)(param_3 + 8) + (int)*(short *)(&DAT_006c2df0 + iVar2) +
            (int)((uint)*(byte *)(*(int *)(param_2 + 600) + 8) *
