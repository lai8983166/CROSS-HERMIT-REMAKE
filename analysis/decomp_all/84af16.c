...
void FUN__text1__0084af16(uint *param_1,int param_2)

{
  ...
  if ((local_8 & 1) == 0) {
    ...
    *piVar3 = *piVar3 + -1;
    if (*piVar3 == 0) {
      if (DAT_00876b30 != (uint *)0x0) {
        VirtualFree((LPVOID)(DAT_00876b28 * 0x8000 + DAT_00876b30[3]),0x8000,0x4000);
        DAT_00876b30[2] = DAT_00876b30[2] | 0x80000000U >> ((byte)DAT_00876b28 & 0x1f);
        *(undefined4 *)(DAT_00876b30[4] + 0xc4 + DAT_00876b28 * 4) = 0;
        *(char *)(DAT_00876b30[4] + 0x43) = *(char *)(DAT_00876b30[4] + 0x43) + -1;
        if (*(char *)(DAT_00876b30[4] + 0x43) == '\0') {
          DAT_00876b30[1] = DAT_00876b30[1] & 0xfffffffe;
        }
        if (DAT_00876b30[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_00876b30[3],0,0x8000);
          HeapFree(DAT_00876b40,0,(LPVOID)DAT_00876b30[4]);
          FUN__text1__008487d0
                    (DAT_00876b30,DAT_00876b30 + 5,
                     (DAT_00876b34 * 0x14 - (int)DAT_00876b30) + -0x14 + DAT_00876b38);
          DAT_00876b34 = DAT_00876b34 + -1;
          if (DAT_00876b30 < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_00876b2c = DAT_00876b38;
        }
      }
      DAT_00876b30 = param_1;
      DAT_00876b28 = uVar14;
    }
  }
  return;
