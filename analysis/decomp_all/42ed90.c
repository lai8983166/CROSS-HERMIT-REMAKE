...
void FUN__text__0042ed90(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9260) = uVar1;
  FUN__text__004993d0(*(undefined4 *)(local_8 + 0x9250),*(undefined2 *)(local_8 + 0x9254),
                      *(undefined2 *)(local_8 + 0x9258),*(undefined4 *)(local_8 + 0x925c),
                      *(undefined4 *)(local_8 + 0x9260));
  local_8 = 0x42eee6;
  FUN__text__0056ce80();
  return;
}
