...
void __fastcall FUN__text__004fdca0(int param_1)

{
  ...
  if (*(char *)(param_1 + 0x39) == '\x03') {
    *(undefined *)(param_1 + 0x69) = (&DAT_00757960)[*(byte *)(param_1 + 0x51)];
  ...
  if (*(char *)(param_1 + 0x3a) == '\x03') {
    *(undefined *)(param_1 + 0x6a) = (&DAT_00757960)[*(byte *)(param_1 + 0x52)];
