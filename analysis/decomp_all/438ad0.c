...
void __thiscall
FUN__text__00438ad0(int param_1,undefined2 param_2,undefined2 param_3,ushort param_4,ushort param_5,
...

{
  ...
  *(undefined4 *)(param_1 + 0x14) = param_7;
  local_8 = param_1;
  local_c = FUN__text__004388e0(param_2,param_3,param_4,param_5,param_8);
  if (local_c != 0) {
    FUN__text__00437c90(param_6);
