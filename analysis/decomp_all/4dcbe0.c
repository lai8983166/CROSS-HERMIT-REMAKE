...
void FUN__text__004dcbe0(int param_1,void *param_2)

{
  ...
  *(undefined2 *)((int)param_2 + 2) = uVar1;
  local_1c = (int)*(short *)(local_8 + 0x24);
  local_20 = (uint)*(byte *)(param_1 + 0x2c);
  local_24 = (int)*(short *)(local_8 + 0x26);
  local_c = __ftol();
  uVar1 = FUN__text__004db650(local_c,0xffff8300,32000);
  *(undefined2 *)((int)param_2 + 4) = uVar1;
  local_8 = (undefined *)0x4dccc6;
  FUN__text__0056ce80();
  return;
}
