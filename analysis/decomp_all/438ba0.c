...
void __thiscall
FUN__text__00438ba0(int param_1,ushort param_2,ushort param_3,int param_4,int param_5,
...

{
  ...
  *(undefined4 *)(param_1 + 0x14) = param_6;
  ...
  local_8 = param_1;
  while( true ) {
    local_10 = local_10 + *(short *)(&DAT_005ff95c + param_4 * 4);
    local_14 = local_14 + *(short *)(&DAT_005ff95e + param_4 * 4);
