...
/* WARNING: Removing unreachable block (ram,0x004b1080) */

void FUN__text__004b0f80(void)
...
LAB__text__004b107a:
    ...
    FUN__text__004d5c40(local_24,(local_c & 0xffff) + 0x22);
    if (((local_18 & 0xffff) != 0) && ((local_20 & 1) != 0)) {
      FUN__text__004db2b0(5);
      iVar1 = ((local_c & 0xffff) + 0x1f) * 0x10;
      local_14 = &DAT_0061bae0 + iVar1;
      uVar2 = (undefined2)((uint)local_14 >> 0x10);
      FUN__text__004d67f0(0xd,0x3e,CONCAT22(uVar2,*(undefined2 *)(&DAT_0061bae2 + iVar1)),
