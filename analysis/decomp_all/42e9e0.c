...
void FUN__text__0042e9e0(undefined4 param_1,int param_2)

{
  ...
  *(undefined1 *)(local_8 + 0x92e0) = 1;
  FUN__text__00499560(*(undefined4 *)(local_8 + 0x9250),*(undefined4 *)(local_8 + 0x9254),
