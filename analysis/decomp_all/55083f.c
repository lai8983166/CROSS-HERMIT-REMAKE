...
void FUN__text__0055083f(uint param_1,undefined4 *param_2,undefined4 *param_3,undefined4 *param_4,
...

{
  ...
  do {
    ...
    uVar29 = CONCAT22((short)DAT_0080a3a0._4_4_,
                      (short)(CONCAT35(CONCAT21(uVar15,(char)((uint)(undefined4)DAT_0080a3a0 >> 0x10
                                                             )),
                                       CONCAT14((char)((uint)uVar29 >> 0x10),uVar29)) >> 0x20));
    uVar13 = (uint)DAT_0080a3a0._4_4_ >> 0x10;
    *param_6 = CONCAT17((0 < sVar9) * (sVar9 < 0x100) * (char)((ulonglong)uVar18 >> 0x30) -
    ...
    uVar16 = packssdw(CONCAT44((int)((int)((ulonglong)uVar26 >> 0x20) +
                      ...
                      CONCAT44((int)(CONCAT26((short)uVar13,CONCAT24(uVar15,uVar29)) >> 0x20),
