...
void __fastcall FUN__text__004f9fc0(int param_1)

{
  ...
  if (*(char *)(param_1 + 0x39) == '\x03') {
    *(undefined *)(param_1 + 0x69) = (&DAT_00755d18)[*(byte *)(param_1 + 0x51)];
  ...
  if (*(char *)(param_1 + 0x3a) == '\x03') {
    *(undefined *)(param_1 + 0x6a) = (&DAT_00755d58)[*(byte *)(param_1 + 0x52)];
  ...
  if (*(char *)(param_1 + 0x3b) == '\x03') {
    *(undefined *)(param_1 + 0x6b) = (&DAT_00755d84)[*(byte *)(param_1 + 0x53)];
