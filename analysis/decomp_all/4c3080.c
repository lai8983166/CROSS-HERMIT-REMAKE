...
void FUN__text__004c3080(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9278) = uVar1;
  uVar1 = FUN__text__004c1eb0(param_1,*(uint *)(local_c + 0x30) >> 0x1c,
                              *(uint *)(local_c + 0x30) & 0xfffffff);
  *(undefined4 *)(local_8 + 0x927c) = uVar1;
  uVar1 = FUN__text__004c1eb0(param_1,*(uint *)(local_c + 0x34) >> 0x1c,
                              *(uint *)(local_c + 0x34) & 0xfffffff);
  *(undefined4 *)(local_8 + 0x9280) = uVar1;
  local_10 = (undefined1 *)(local_8 + 0x228 + *(int *)(local_8 + 0x9250) * 0x1a);
  *local_10 = 1;
  FUN__text__004cb9f0(4);
  ...
  FUN__text__004cb8e0(*(undefined4 *)(local_8 + 0x9274));
  FUN__text__004cb890(*(undefined4 *)(local_8 + 0x9278),*(undefined4 *)(local_8 + 0x927c),
                      *(undefined4 *)(local_8 + 0x9280));
  local_8 = 0x4c33ef;
  FUN__text__0056ce80();
  return;
}
