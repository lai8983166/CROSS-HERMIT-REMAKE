...
char * FUN_00562570(int param_1)

{
  if (param_1 < -0x7789feab) {
    if (param_1 == -0x7789feac) {
      return "DDERR_NOZBUFFERHW";
    }
    if (param_1 < -0x7ff8fb81) {
      if (param_1 == -0x7ff8fb82) {
        return "DIERR_OLDDIRECTINPUTVERSION";
      }
      if (param_1 < -0x7ffbfdb8) {
        if (param_1 == -0x7ffbfdb9) {
      ...
      else if (param_1 < -0x7ffbfd7a) {
        if (param_1 == -0x7ffbfd7b) {
    ...
    else if (param_1 < -0x7fea7d7f) {
      if (param_1 == -0x7fea7d80) {
        return "DPNERR_INCOMPLETEADDRESS";
      }
      if (param_1 < -0x7feafe7b) {
        if (param_1 == -0x7feafe7c) {
      ...
      if (param_1 < -0x7789ff69) {
        if (param_1 == -0x7789ff6a) {
          return "DDERR_INVALIDRECT";
        }
        if (param_1 < -0x7789ff9b) {
  ...
  else if (param_1 < -0x7787eeee) {
    if (param_1 == -0x7787eeef) {
      return "DMUS_E_ALREADY_LOADED";
    }
    if (param_1 < -0x7789fcad) {
      if (param_1 == -0x7789fcae) {
      ...
      if (param_1 < -0x7789fdc1) {
        ...
        if (param_1 < -0x7789fdf7) {
          ...
          if (param_1 < -0x7789fe51) {
            if (param_1 == -0x7789fe52) {
              return "DDERR_SURFACEBUSY";
            }
            if (param_1 < -0x7789fe7f) {
    ...
    if (param_1 < 0x8780015) {
      if (param_1 == 0x8780014) {
