...
void __thiscall
FUN__text__0044f940(int param_1,ushort param_2,ushort param_3,int param_4,int param_5,
...

{
  ...
  *(undefined4 *)(param_1 + 0xc) = param_6;
  ...
  local_8 = param_1;
  while( true ) {
    local_10 = local_10 + *(short *)(&DAT_00606910 + param_4 * 4);
    local_14 = local_14 + *(short *)(&DAT_00606912 + param_4 * 4);
    if (((((short)local_10 < 0) || (*(int *)(local_8 + 0x40) <= (int)(short)local_10)) ||
        ((short)local_14 < 0)) ||
       ((*(int *)(local_8 + 0x44) <= (int)(short)local_14 ||
        (local_c = FUN__text__0044f680(CONCAT22((short)local_14 >> 0xf,param_2),param_3,local_10,
