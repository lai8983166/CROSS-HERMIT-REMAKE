...
void __thiscall
FUN__text__00465140(int param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined2 param_5
  ...
  if (*(short *)(param_1 + 0x48) != -1) {
    ...
    if (((local_10 < 0) || (199 < local_10)) &&
       (iVar2 = FUN__text__00424f80("(0<=no )&&(no <=199)",
                                    "E:\\CrossHermit\\GAME\\src\\yoshida\\UnitAnim.cpp",
                                    DAT_0061052c + 10,0), iVar2 != 0)) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    local_14 = &DAT_0060f890 + local_10 * 4 + local_c * 800;
    FUN__text__0040af40(param_2,param_3,local_14[1],local_14[2],param_5,
                        CONCAT22((short)((uint)local_14 >> 0x10),param_6),param_7,*local_14);
  }
  local_8 = 0x465276;
  FUN__text__0056ce80();
  return;
