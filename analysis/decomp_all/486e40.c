...
/* WARNING: Removing unreachable block (ram,0x00486fb2) */

void FUN__text__00486e40(int param_1,undefined4 param_2,undefined4 *param_3)

{
  ...
  if (local_ac == '\0') {
    ...
    *(undefined1 *)((int)param_3 + 9) = *(undefined1 *)(param_1 + 0x4f1);
    ...
    FUN__text__0046beb0(param_1,0xc12,local_7c,local_80,0,param_3);
  }
  else if (local_ac == '\x01') {
    *(char *)((int)param_3 + 7) = *(char *)((int)param_3 + 7) + '\x01';
    local_94 = (uint)DAT_006c4146 +
               ((uint)*(byte *)(*(int *)(param_1 + 600) + 10) * (uint)DAT_006c4147) / 100;
    if (0x20 < local_94) {
      local_94 = 0x20;
    }
    ...
    for (local_8c = 0; local_8c != *local_c; local_8c = local_8c + 1) {
      ...
      if ((iVar4 != 0) && (*(short *)(param_1 + 2) != *(short *)(local_a8 + 2))) {
        ...
        if (iVar4 != 0) {
          ...
          iVar4 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                      DAT_00618f4c + 0x4b);
          FUN__text__0046beb0(local_a8,0xc14,iVar4 % 0x14 + -10,iVar5,uVar7,puVar8);
          local_90 = local_90 + 1;
        }
      }
    }
