...
void blit_0x422f20(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (param_1 != 0) {
    ...
    if (iStack_30 != 0) {
      ...
      if (iStack_24 != 0) {
        ...
        __chkesp();
        (*API_GDI32_DLL_BitBlt)(iStack_30,0,0,uStack_1c,uStack_18,param_1,0,0,0xcc0020);
        iStack_5c = __chkesp();
      }
    }
    if (iStack_30 != 0) {
    ...
    if (iStack_24 != 0) {
      uStack_2c = func_0x004232f0(uStack_28,uStack_1c,uStack_18,param_4);
      (*API_GDI32_DLL_DeleteObject)(iStack_24);
      __chkesp();
    }
  }
  puStack_8 = &UNK_004230f0;
  __chkesp();
  return;
}
