...
void __thiscall FUN__text__00534f1b(int param_1,int param_2,int param_3,float *param_4)

{
  ...
  pcVar3 = (char *)(*(int *)(param_1 + 0x1050) * param_2 + *(int *)(param_1 + 0x1054) * param_3 +
                   *(int *)(param_1 + 0x18));
  pcVar1 = pcVar3 + *(int *)(param_1 + 0x1058) * 4;
  for (; pcVar3 < pcVar1; pcVar3 = pcVar3 + 4) {
    *param_4 = (float)(int)*pcVar3 * fVar2;
    param_4[1] = (float)(int)pcVar3[1] * fVar2;
    param_4[2] = (float)(int)pcVar3[2] * fVar2;
    param_4[3] = (float)(int)pcVar3[3] * fVar2;
    param_4 = param_4 + 4;
  }
