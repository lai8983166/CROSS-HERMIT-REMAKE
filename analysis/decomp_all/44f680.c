...
void __thiscall
FUN__text__0044f680(int param_1,short param_2,short param_3,short param_4,short param_5,int param_6)

{
  ...
  if (local_18 < local_1c) {
    for (local_14 = 0; local_14 < local_1c; local_14 = local_14 + 1) {
      ...
      iVar1 = FUN__text__0043bfa0(local_c,local_10,*(undefined4 *)(local_8 + 0xc));
      if ((iVar1 == 0) ||
