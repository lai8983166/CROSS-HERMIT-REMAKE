...
void __thiscall FUN__text__0040f0d0(int param_1,int param_2,uint param_3)

{
  ...
  local_18 = 0x3f800000;
  local_14 = *(undefined4 *)(param_2 + 0x20);
  local_44 = local_58;
  local_30 = local_58;
  local_1c = local_58;
  local_8 = param_1;
  ...
  if (local_88 == '\x01') {
    if ((*(uint *)(local_10 + 0x14) & *(uint *)(local_10 + 0x18) & *(uint *)(local_10 + 0x1c) &
         *(uint *)(local_10 + 0x20) & 0xff000000) != 0xff000000) {
