...
void FUN__text__004c4130(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9250) = uVar1;
  iVar2 = _rand();
  *(int *)(local_8 + 0x9254) = (iVar2 * *(int *)(local_8 + 0x9250)) / 0x7fff;
  local_c = *(uint *)(local_14 + 4) >> 0x1c;
  local_10 = *(uint *)(local_14 + 4) & 0xfffffff;
  FUN__text__004c1f40(param_1,local_c,local_10,*(undefined4 *)(local_8 + 0x9254));
  local_8 = 0x4c420a;
  FUN__text__0056ce80();
  return;
}
