...
void FUN__text__004c3dc0(undefined4 param_1,int param_2)

{
  ...
  *(undefined4 *)(local_8 + 0x9260) = uVar1;
  local_10 = local_8 + 0x228 + *(int *)(local_8 + 0x9250) * 0x1a;
  FUN__text__004cb910(*(undefined4 *)(local_8 + 0x9254),*(undefined4 *)(local_8 + 0x9258),
                      *(undefined4 *)(local_8 + 0x925c),*(undefined4 *)(local_8 + 0x9260));
  local_8 = 0x4c3f33;
  FUN__text__0056ce80();
  return;
}
