...
void FUN__text__00408d30(float *param_1,float *param_2,float param_3,float param_4,short param_5)

{
  ...
  *param_1 = (float)((float10)local_28 - fVar3 * (float10)local_30);
  ...
  fVar3 = (float10)FUN__text__0056d9d4((double)local_14);
  *param_2 = (float)(fVar3 * (float10)local_48 + (float10)local_40);
