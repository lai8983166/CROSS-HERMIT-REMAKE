...
void FUN__text__00497ec0(undefined4 param_1)

{
  ...
  iVar3 = *(int *)(DAT_007a49f4 + 0x80f68 + local_10 * 0x520);
  iVar1 = *(int *)(DAT_007a49f4 + 0x80f6c + local_10 * 0x520);
