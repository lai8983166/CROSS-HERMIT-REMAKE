...
/* WARNING: Removing unreachable block (ram,0x00485989) */

void __thiscall FUN__text__004858d0(int param_1,int param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  if (local_40 == '\0') {
    *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
    ...
    if ((local_40 == '\x02') &&
       (iVar3 = FUN__text__00424f80(&DAT_0059ddbc,
                                    "E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f34 + 0x39,0), iVar3 != 0)) {
      pcVar1 = (code *)swi(3);
      (*pcVar1)();
      return;
    }
    goto LAB__text__00485bb2;
  }
  *(char *)((int)param_4 + 7) = *(char *)((int)param_4 + 7) + '\x01';
  ...
  for (local_20 = 0; local_20 != *local_c; local_20 = local_20 + 1) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        iVar3 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                    DAT_00618f34 + 0x2f);
        FUN__text__0046beb0(local_3c,0xbf7,iVar3 % 0x14 + -10,iVar4,uVar6,puVar7);
        local_24 = local_24 + 1;
      }
    }
  }
