...
void FUN__text__0048baf0(int param_1,int param_2,undefined4 param_3,undefined4 param_4,
                        undefined4 param_5)

{
  ...
  local_10 = FUN__text__0048b720(param_1,5,param_2);
  ...
  FUN__text__0048c850(param_1,5,0,local_18,param_2,param_3,param_4,param_5);
  local_8 = 0x48bbcb;
  FUN__text__0056ce80();
  return;
}
