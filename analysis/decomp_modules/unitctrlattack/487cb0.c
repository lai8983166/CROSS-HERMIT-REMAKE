...
/* WARNING: Removing unreachable block (ram,0x00487e30) */

void FUN__text__00487cb0(int param_1,undefined4 param_2,undefined4 *param_3)

{
  ...
  iVar4 = *(short *)(param_3 + 1) * 0x48;
  local_78 = &DAT_006c2dc8 + iVar4;
  ...
  if (local_ac == '\0') {
    ...
    *(undefined1 *)((int)param_3 + 9) = *(undefined1 *)(param_1 + 0x4f1);
    ...
    FUN__text__0046beb0(param_1,0xc1b,local_7c,local_80,0,param_3);
  }
  else if (local_ac == '\x01') {
    *(char *)((int)param_3 + 7) = *(char *)((int)param_3 + 7) + '\x01';
    local_94 = (uint)(byte)(&DAT_006c2dde)[iVar4] +
               ((uint)*(byte *)(*(int *)(param_1 + 600) + 10) * (uint)(byte)(&DAT_006c2ddf)[iVar4])
               / 100;
    if (0x20 < local_94) {
      local_94 = 0x20;
    }
    ...
    for (local_8c = 0; local_8c != *local_c; local_8c = local_8c + 1) {
      ...
      iVar4 = FUN__text__0048c950((int)*(short *)(param_3 + 1),param_1,local_a8);
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          ...
          iVar4 = FUN__text__00467e00("E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                      DAT_00618f58 + 0x46);
          FUN__text__0046beb0(local_a8,0xc1d,iVar4 % 0x14 + -10,iVar5,uVar7,puVar8);
          local_90 = local_90 + 1;
        }
      }
    }
          ...
          (iVar4 = FUN__text__00424f80(&DAT_0059e1e0,
                                       "E:\\CrossHermit\\GAME\\SRC\\YOSHIDA\\UnitCtrlAttack.cpp",
                                       DAT_00618f58 + 0x4e,0), iVar4 != 0)) {
    pcVar1 = (code *)swi(3);
    (*pcVar1)();
    return;
  }
