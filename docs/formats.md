...
- **`##E.BIN` (01E..53E) = 特效档**: 全档单色相 (如 01E = 品红斩击 + 蓝色光球), E = Effect。同容器 9 块格式; 块0 动画为**播一次序列** (首帧 dur=20 定格 + 后续 dur=6 降序帧串); 01E 实测: #14..#28 帧引用把 5..93 分成连续带 = 各特效帧带 (视觉标注: #15=紫月斩 #18=短斩 #19=竖劈 #20=横扫 #28=光球弹丸; 帧31..75=蓝色软泥/弹体素材带 (#21..25, 曾误配致'蓝史莱姆'事故)), #1..#13 全为外部引用 (帧号 ≥ 本档帧数, 跨档续编语义开口) — tools/fx_export.py
